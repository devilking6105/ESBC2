...
/** Utility functions used by the esbcoin Qt UI.
 */
namespace GUIUtil
{
...
// Render esbcoin addresses in monospace font
...
// Parse "esbcoin:" URI into recipient object, return true on successful parsing
